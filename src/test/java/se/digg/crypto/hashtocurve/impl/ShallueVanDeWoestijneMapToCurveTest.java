...
public class ShallueVanDeWoestijneMapToCurveTest {
    ...
    */
    ...
    void processTest_WithGivenElement_ShouldWorkAsExpected() throws Exception {
        ...
        testSpecificMapping(new BigInteger(1, Hex.decode("ad5342c66a6dd0ff080df1da0ea1c04b96e0330dd89406465eeba11582515009")), mapToCurve);
        testSpecificMapping(new BigInteger(1, Hex.decode("8c0f1d43204bd6f6ea70ae8013070a1518b43873bcd850aafa0a9e220e2eea5a")), mapToCurve);
